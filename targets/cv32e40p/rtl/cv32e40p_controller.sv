...
(
  ...
  // ARVIS_HWLP_BEGIN: REMOVE
  output logic        hwlp_mask_o,                // prevent writes on the hwloop instructions in case interrupt are taken
  // ARVIS_HWLP_END: REMOVE
  // from IF/ID pipeline
  ...
  // from hwloop_regs
  // ARVIS_HWLP_BEGIN: controller_ports
  ...
  // ARVIS_HWLP_END: controller_ports

  // ARVIS_HWLP_BEGIN: REMOVE
  output logic              hwlp_jump_o,
  // ARVIS_HWLP_END: REMOVE

  // ARVIS_HWLP_BEGIN: KEEP
  ...
  // ARVIS_HWLP_BEGIN: controller_logic_declaration
  ...
  // ARVIS_HWLP_END: controller_logic_declaration
  ...
  begin
    ...
    exc_cause_o            = '0;
    // ARVIS_IRQ_BEGIN: controller_exc_pc_mux_init
    exc_pc_mux_o           = EXC_PC_IRQ;
    // ARVIS_IRQ_END: controller_exc_pc_mux_init
    ...
    hwlp_dec_cnt_o          = '0;
    hwlp_end_4_id_d         = '0;
    // ARVIS_HWLP_BEGIN: controller_decode_hwloop_defaults
    // ARVIS_HWLP_END: controller_decode_hwloop_defaults
    // ARVIS_HWLP_END: KEEP

    // When the controller tells to hwlp-jump, the prefetcher does not always jump immediately,
    // but the aligner immediately modifies pc_id to HWLP_BEGIN. This condition on hwlp_targ_addr_o
    // ensures that the target is kept constant even if pc_id is no more HWLP_END
    // ARVIS_HWLP_BEGIN: controller_target_addr_o_declaration
    hwlp_targ_addr_o        = ((hwlp_start1_leq_pc && hwlp_end1_geq_pc) && !(hwlp_start0_leq_pc && hwlp_end0_geq_pc)) ? hwlp_start_addr_i[1] : hwlp_start_addr_i[0];
    // ARVIS_HWLP_END: controller_target_addr_o_declaration
    ...
    unique case (ctrl_fsm_cs)
      ...
      begin
        ...
        // handle interrupts
        // ARVIS_CTRL_BEGIN: first_fetch_irq_block
        ...
        // ARVIS_CTRL_END: first_fetch_irq_block
      end
      ...
      begin
          ...
          begin
            ...
            halt_if_o         = 1'b1;
            csr_save_if_o     = 1'b1;
            // ARVIS_DBG_BEGIN: ctrl_csr_save_cause
            csr_save_cause_o  = !debug_mode_q;
            // ARVIS_DBG_END: ctrl_csr_save_cause
          ...
          begin: blk_decode_level1 // now analyze the current instruction in the ID stage
            ...
            // ARVIS_DBG_END: REMOVE
            // ARVIS_CTRL_BEGIN: decode_irq_block
            if (irq_req_ctrl_i)
              begin
                // Taken IRQ
                // ARVIS_HWLP_BEGIN: REMOVE
            ...
            // ARVIS_CTRL_END: decode_irq_block
              begin
                ...
                if (illegal_insn_i) begin
                  ...
                  unique case (1'b1)
                    ...
                    // ARVIS_DBG_BEGIN: ctrl_xret_case_label
                    mret_insn_i | uret_insn_i | dret_insn_i: begin
                    // ARVIS_DBG_END: ctrl_xret_case_label
                      halt_if_o     = 1'b1;
                      halt_id_o     = 1'b0;
                      ctrl_fsm_ns           = id_ready_i ? FLUSH_EX : DECODE;
                    end
                    ...
                    csr_status_i: begin
                      ...
                      if (~id_ready_i) begin
                        ...
                        // ARVIS_HWLP_BEGIN: controller_dec_fire
                        ...
                        // ARVIS_HWLP_END: controller_dec_fire
                      end
                    end
                    ...
                    default: begin
                      // ARVIS_HWLP_BEGIN: controller_decode_default_hwlp 
                      ...
                      // ARVIS_HWLP_END: controller_decode_default_hwlp
                    end
      ...
      begin
        if (HW_LOOP) begin
          // ARVIS_HWLP_BEGIN: controller_decode_hwloop_entry
          // ARVIS_HWLP_END: controller_decode_hwloop_entry
          ...
          begin // now analyze the current instruction in the ID stage
            ...
            // ARVIS_DBG_END: REMOVE
            // ARVIS_CTRL_BEGIN: decode_hwloop_irq_block
            if (irq_req_ctrl_i && ~debug_mode_q)
              begin
                // Taken IRQ
                // ARVIS_HWLP_BEGIN: REMOVE
                hwlp_mask_o       = HW_LOOP ? 1'b1 : 1'b0;
            ...
            // ARVIS_CTRL_END: decode_hwloop_irq_block
              begin
                ...
                if (illegal_insn_i) begin
                  ...
                  unique case (1'b1)
                    ...
                    default: begin
                      // ARVIS_HWLP_BEGIN: controller_decode_hwloop_default
                       // we can be at the end of HWloop due to a return from interrupt or ecall or ebreak or exceptions
                      ...
                      // ARVIS_HWLP_END: controller_decode_hwloop_default
          ...
          // ARVIS_HWLP_BEGIN: controller_decode_hwloop_exit
          // ARVIS_HWLP_END: controller_decode_hwloop_exit
        end
      end
      // ARVIS_HWLP_END: KEEP
      ...
      begin
        if (COREV_CLUSTER == 1'b1) begin
          ...
          // ARVIS_CTRL_BEGIN: irq_flush_elw_irq_block
          if (irq_req_ctrl_i && ~(debug_req_pending || debug_mode_q)) begin
            // Taken IRQ
            is_decoding_o     = 1'b0;
            halt_if_o         = 1'b1;
          ...
          // ARVIS_CTRL_END: irq_flush_elw_irq_block
        end
      end
      ...
      begin
        if (COREV_CLUSTER == 1'b1) begin
          ...
          if(id_ready_i)
            // ARVIS_CTRL_BEGIN: elw_exe_next_state
            ctrl_fsm_ns = ((debug_req_pending || trigger_match_i) & ~debug_mode_q) ? DBG_FLUSH : IRQ_FLUSH_ELW;
            // ARVIS_CTRL_END: elw_exe_next_state
      ...
      begin
        ...
        if(data_err_q) begin
            ...
            pc_set_o              = 1'b1;
            trap_addr_mux_o       = TRAP_MACHINE;
            // ARVIS_DBG_BEGIN: ctrl_exc_pc_mux
            exc_pc_mux_o          = debug_mode_q ? EXC_PC_DBE : EXC_PC_EXCEPTION;
            // ARVIS_DBG_END: ctrl_exc_pc_mux
      ...
      begin
        ...
        unique case(1'b1)
          mret_dec_i: begin
              //mret
              // ARVIS_DBG_BEGIN: ctrl_pc_mux_mret
              pc_mux_o              = debug_mode_q ? PC_EXCEPTION : PC_MRET;
              pc_set_o              = 1'b1;
              exc_pc_mux_o          = EXC_PC_DBE; // only used if in debug_mode
              // ARVIS_DBG_END: ctrl_pc_mux_mret
          end
          uret_dec_i: begin
              //uret
              // ARVIS_DBG_BEGIN: ctrl_pc_mux_uret
              pc_mux_o              = debug_mode_q ? PC_EXCEPTION : PC_URET;
              pc_set_o              = 1'b1;
              exc_pc_mux_o          = EXC_PC_DBE; // only used if in debug_mode
              // ARVIS_DBG_END: ctrl_pc_mux_uret
          end
          // ARVIS_DBG_BEGIN: REMOVE
          dret_dec_i: begin
              //dret
    ...
    // ARVIS_HWLP_BEGIN: controller_global_innermost_dec
    // ARVIS_HWLP_END: controller_global_innermost_dec
  end



// ARVIS_HWLP_BEGIN: controller_gen_hwlp
generate
...
endgenerate
// ARVIS_HWLP_END: controller_gen_hwlp
  ...
  // ARVIS_CTRL_BEGIN: ctrl_wake_from_sleep
  assign wake_from_sleep_o = irq_wu_ctrl_i || debug_req_pending || debug_mode_q;
  // ARVIS_CTRL_END: ctrl_wake_from_sleep
  ...
  // ARVIS_DBG_BEGIN: controller_wfi_gating
  // Gate off wfi 
  assign wfi_active = wfi_i & ~debug_wfi_no_sleep_o;
  // ARVIS_DBG_END: controller_wfi_gating
