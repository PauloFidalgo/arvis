...
(
  ...
  // ARVIS_PULP_BEGIN: mul_short_round
  // prepare the rounding value
  assign short_round_tmp = (32'h00000001) << imm_i;
  assign short_round = (operator_i == MUL_IR) ? {1'b0, short_round_tmp[31:1]} : '0;
  // ARVIS_PULP_END: mul_short_round
  ...
  always_comb begin
    ...
    unique case (operator_i)
      ...
      // ARVIS_PULP_BEGIN: mul_result_pulp_short
      MUL_I, MUL_IR, MUL_H: result_o = short_result[31:0];
      // ARVIS_PULP_END: mul_result_pulp_short
      ...
      // ARVIS_FUSED_BEGIN: mult_result_mux
      // ARVIS_FUSED_END: mult_result_mux
