...
(
    ...
    // ARVIS_PULP_BEGIN: REMOVE
    input logic [1:0] vector_mode_i,
    // ARVIS_PULP_END: REMOVE
    // ARVIS_PULP_BEGIN: REMOVE
  ...
  always_comb begin
    ...
    // ARVIS_PULP_BEGIN: alu_adder_carry_condition
    if (adder_op_b_negate || (operator_i == ALU_ABS || operator_i == ALU_CLIP)) begin
    // ARVIS_PULP_END: alu_adder_carry_condition
  ...
  // ARVIS_PULP_BEGIN: alu_round_value
  assign adder_round_value  = ((operator_i == ALU_ADDR) || (operator_i == ALU_SUBR) ||
                               (operator_i == ALU_ADDUR) || (operator_i == ALU_SUBUR)) ?
                                {
    1'b0, bmask[31:1]
  } : '0;
  // ARVIS_PULP_END: alu_round_value
  ...
  // ARVIS_PULP_BEGIN: alu_shift_amt_left_vec
  ...
  // ARVIS_PULP_END: alu_shift_amt_left_vec

  // ALU_FL1 and ALU_CBL are used for the bit counting ops later
  // ARVIS_PULP_BEGIN: alu_shift_left
  assign shift_left = (operator_i == ALU_SLL) || (operator_i == ALU_BINS) ||
                      (operator_i == ALU_FL1) || (operator_i == ALU_CLB)  ||
                      (operator_i == ALU_DIV) || (operator_i == ALU_DIVU) ||
                      (operator_i == ALU_REM) || (operator_i == ALU_REMU) ||
                      (operator_i == ALU_BREV);
  // ARVIS_PULP_END: alu_shift_left

  // ARVIS_PULP_BEGIN: alu_shift_use_round
  assign shift_use_round = (operator_i == ALU_ADD)   || (operator_i == ALU_SUB)   ||
                           (operator_i == ALU_ADDR)  || (operator_i == ALU_SUBR)  ||
                           (operator_i == ALU_ADDU)  || (operator_i == ALU_SUBU)  ||
                           (operator_i == ALU_ADDUR) || (operator_i == ALU_SUBUR);
  // ARVIS_PULP_END: alu_shift_use_round

  // ARVIS_PULP_BEGIN: alu_shift_arithmetic
  assign shift_arithmetic = (operator_i == ALU_SRA)  || (operator_i == ALU_BEXT) ||
                            (operator_i == ALU_ADD)  || (operator_i == ALU_SUB)  ||
                            (operator_i == ALU_ADDR) || (operator_i == ALU_SUBR);
  // ARVIS_PULP_END: alu_shift_arithmetic
  ...
  // ARVIS_PULP_BEGIN: alu_shift_amt_norm
  assign shift_amt_norm = is_clpx_i ? {clpx_shift_ex, clpx_shift_ex} : {4{3'b000, bmask_b_i}};
  // ARVIS_PULP_END: alu_shift_amt_norm
  ...
  // ARVIS_PULP_BEGIN: alu_shift_ror
  assign shift_op_a_32 = (operator_i == ALU_ROR) ? {
        shift_op_a, shift_op_a
      } : $signed(
          {{32{shift_arithmetic & shift_op_a[31]}}, shift_op_a}
      );
  // ARVIS_PULP_END: alu_shift_ror

  // ARVIS_PULP_BEGIN: alu_shift_right_vec
  always_comb begin
    case (vector_mode_i)
      VEC_MODE16: begin
  ...
  // ARVIS_PULP_END: alu_shift_right_vec
  ...
  always_comb begin
    ...
    unique case (operator_i)
      ...
      ALU_LTS,
      ALU_LES,
      // ARVIS_PULP_BEGIN: alu_cmp_signed_pulp
      ALU_SLTS,
      ALU_SLETS,
      ALU_MIN,
      ALU_MAX,
      ...
      ALU_CLIP,
      ALU_CLIPU: begin
      // ARVIS_PULP_END: alu_cmp_signed_pulp
        // ARVIS_PULP_BEGIN: alu_cmp_signed_vec
        case (vector_mode_i)
          VEC_MODE8:  cmp_signed[3:0] = 4'b1111;
          VEC_MODE16: cmp_signed[3:0] = 4'b1010;
          default:    cmp_signed[3:0] = 4'b1000;
        endcase
        // ARVIS_PULP_END: alu_cmp_signed_vec
      end
  ...
  // ARVIS_FUSED_BEGIN: alu_operations
  // ARVIS_FUSED_END: alu_operations
  ...
  always_comb begin
    ...
    unique case (operator_i)
      ...
      // ARVIS_FUSED_BEGIN: result_mux
      // ARVIS_FUSED_END: result_mux
