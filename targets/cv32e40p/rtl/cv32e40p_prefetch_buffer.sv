...
module cv32e40p_prefetch_buffer #(
    ...
    parameter HW_LOOP = 1  // PULP ISA Extension (including PULP specific CSRs and hardware loop, excluding p.elw)
) (
    input logic clk,
    input logic rst_n,
    ...
    // ARVIS_HWLP_BEGIN: prefetch_buf_ports
    // ARVIS_HWLP_END: prefetch_buf_ports
  ...
  cv32e40p_prefetch_controller #(
      ...
      // ARVIS_HWLP_END: REMOVE
      // ARVIS_HWLP_BEGIN: prefetch_buf_conn
      // ARVIS_HWLP_END: prefetch_buf_conn
