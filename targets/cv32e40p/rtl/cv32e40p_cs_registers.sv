...
#(
    ...
    // Hardware loops
    input logic [HW_LOOP-1:0][31:0] hwlp_start_i,
    input logic [HW_LOOP-1:0][31:0] hwlp_end_i,
    input logic [HW_LOOP-1:0][31:0] hwlp_cnt_i,
          ...
          unique case (priv_lvl_q)
            ...
            PRIV_LVL_U: begin
              if (~is_irq) begin
                ...
                // ARVIS_DBG_BEGIN: cs_regs_if_debug
                if (debug_csr_save_i) depc_n = exception_pc;
                else mepc_n = exception_pc;
                // ARVIS_DBG_END: cs_regs_if_debug
  ...
  // ARVIS_DBG_BEGIN: csr_irq_enable
  assign m_irq_enable_o = mstatus_q.mie && !(dcsr_q.step && !dcsr_q.stepie);
  assign u_irq_enable_o = mstatus_q.uie && !(dcsr_q.step && !dcsr_q.stepie);
  // ARVIS_DBG_END: csr_irq_enable
