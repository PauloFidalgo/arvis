...
(
 ...
 // ARVIS_DBG_END: REMOVE
  ...
  // ARVIS_HWLP_BEGIN: decoder_output
  // hwloop signals
  ...
  logic       data_req;
  // ARVIS_HWLP_BEGIN: decoder_hwlp_we_declaration
  logic [2:0] hwlp_we;
  // ARVIS_HWLP_END: decoder_hwlp_we_declaration
  logic       csr_illegal;
  ...
  begin: instruction_decoder
    ...
    // ARVIS_HWLP_BEGIN: decoder_signals_init
    hwlp_we                        = 3'b0;
    hwlp_target_mux_sel_o          = 2'b0;
    hwlp_start_mux_sel_o           = 2'b0;
    hwlp_cnt_mux_sel_o             = 1'b0;
    // ARVIS_HWLP_END: decoder_signals_init
    ...
    unique case (instr_rdata_i[6:0])
      ...
      OPCODE_CUSTOM_0: begin
        // ARVIS_FUSED_BEGIN: decoder_custom0
        // ARVIS_FUSED_END: decoder_custom0
      end
      ...
      // ARVIS_FUSED_BEGIN: decoder_cases
      // ARVIS_FUSED_END: decoder_cases
  ...
  // ARVIS_HWLP_BEGIN: decoder_assert_hwlp_we_o
  assign hwlp_we_o                   = (deassert_we_i) ? 3'b0          : hwlp_we;
  // ARVIS_HWLP_END: decoder_assert_hwlp_we_o
